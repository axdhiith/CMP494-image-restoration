...
from funie_datasets import PairDataset, denorm
from funie_models import FUnIEDiscriminator, FUnIEGeneratorV2, TotalGenLoss
from torch.utils.tensorboard import SummaryWriter
from torchvision.utils import make_grid, save_image
from funie_utils import AverageMeter, ProgressMeter
...
class Trainer(object):
    ...
    def train(self):
        ...
        print(f"\n------SAVING FUNIE-GAN RESULTS AT {args.save_path} ------")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save-path", default="./saved_model/funiegan", type=str, metavar="PATH",
    ...
    trainer.train()
    print("\n\n------TRAINING FUNIE-GAN PIPELINE: COMPLETED------")

...
parser.add_argument('--data_path', default='./EUVP Dataset/Paired/')

parser.add_argument('--checkpoints_dir', default='./saved_model/ckpts/')
...
# Assign the parsed known arguments to the options
opt = known_args
